...
>(({ className, children, background, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(triggerVariants({ background, className }))}
    {...props}
  >
    {children}
...
const SelectContent = React.forwardRef<
  ...
  SelectContentProps
>(({ className, children, position = "popper", background, ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(contentVariants({ background, position, className }))}
      position={position}
      {...props}
    >
