...
export const NeutralButtonDisplay: Story = {
  render: () => {
    const [colors, setColors] = useState<Record<string, LabelColor>>({
      white: "red",
      grey: "red",
      black: "red",
      small: "red",
    ...
    const setColor = (key: string) => (value: LabelColor) =>
          ...
          <VStack gap={4}>
            ...
            <HStack gap={6} align="start">
              <VStack gap={2} align="center">
                ...
                />
                <span className="text-xs text-grey-stronger">
                  défaut (`buttonDisplay="value"`) : la couleur est sur le bouton
                </span>
              </VStack>
              <VStack gap={2} align="center">
                <ButtonThumbnailLabels
